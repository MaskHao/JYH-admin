<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="报名费" prop="prodPrice">{{ GoodForm.GoodPrice }}</el-form-item>
      <el-form-item label="积分" prop="GoodPointPrice">{{ GoodForm.GoodPointPrice }}</el-form-item>
      <el-form-item label="总人数" prop="GoodMarket">{{ GoodForm.GoodStock }}</el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer">
      <el-button @click="cancelBtn">返回活动管理</el-button>
    </div>
  </div>
</template>
...
import { activeInfo } from '@/api/action'
...
export default {
  ...
  methods: {
    ...
    cancelBtn() {
      this.$router.push('/love_notices/ln_list')
    }
  }
}
</script>
